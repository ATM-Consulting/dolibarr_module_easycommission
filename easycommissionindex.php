...
/**
 *	\file       easycommission/easycommissionindex.php
 *	\ingroup    easycommission
 *	\brief      Home page of easycommission top menu
 */
...
$langs->loadLangs(array("easycommission@easycommission"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->easycommission->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("EasyCommissionArea"));

print load_fiche_titre($langs->trans("EasyCommissionArea"), '', 'easycommission.png@easycommission');
...
// Draft MyObject
if (! empty($conf->easycommission->enabled) && $user->rights->easycommission->read)
{
	$langs->load("orders");
